...
(function () {
  ...
  */
  ...
  var paulo = new Person('Paulo', 'Rangel', 60);
  var marcio = new Person('Marcio', 'Neves', 20);
  var rafael = new Person('Rafael', 'Silva', 40);
  ...
  */
  console.log('\nIdade das pessoas:');
  console.log(paulo.getFullName() + ' tem ' + paulo.age);
  console.log(marcio.getFullName() + ' tem ' + marcio.age);
  console.log(rafael.getFullName() + ' tem ' + rafael.age);
