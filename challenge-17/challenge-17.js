(function () {
  ...
  */
  ...
  console.log(text.replace(/(Manuel Marques de Sousa)/, 'Alison Cruz'));
  ...
  */
  ...
  console.log(text.replace(/(O Centauro de Luvas)/, function (texto) { return texto.toUpperCase() }));
  ...
  */
  ...
  var regexDate = /([0-3][0-9]) de (junho|julho) de ([0-9][0-9][0-9][0-9])/g;
  ...
  */
  ...
  var replaceDate = function (match,a1,a2,a3) {
    console.log('ARGUMENTS',arguments);
    return a1 + '/'+ getMonthNumber(a2) + '/'+ a3;
  }


  text = text.replace(regexDate,replaceDate);
